...
// Generate a realistic number of events for a single month view
const numEvents = 300;
...
const oldTime = t1 - t0;
console.log(`Old method took ${oldTime.toFixed(4)} ms. Found ${totalFoundOld} events.`);
...
const newTime = t3 - t2;
console.log(`New method took ${newTime.toFixed(4)} ms. Found ${totalFoundNew} events.`);
