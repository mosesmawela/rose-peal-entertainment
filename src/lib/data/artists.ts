...
export const ARTISTS: Artist[] = [
  {
    ...
    role: "Hip-Hop / Rapper",
    genre: "Hip-Hop / Straata",
    image: "https://ik.imagekit.io/mosesmawela/Rose%20Pearl/maglera%20doe%20boy?updatedAt=1772020851365",
    bio: "Tokelo Moyakhe (born August 3rd, 1993), known professionally as Maglera Doe Boy (M.D.B), is a South African rapper and songwriter. Born in Reitz, Free State, and raised in Kanana township, Klerksdorp, North West province, he began his musical career at a young age. His vernacular style of rap, influenced by Motswako and West Coast Gangster rap, gave birth to a unique style dubbed 'STRAATA'. He released his debut EP 'Progression' in 2015, which garnered national attention and earned recognition on Hype Magazine's 'Top 5 Underrated Mixtapes and EP's'. He has worked with artists including Slikour, Towdee, Cassper Nyovest, Khuli Chana, pH Raw, Reason, and HHP. He was nominated for Hype Magazine's 2017 Freshmen list and began recording with Afro Pop legends the Jaziel Brothers at a very young age.",
    ...
    socials: {
      ...
      youtube: "https://youtube.com/@MagleraDoeBoy",
    },
    releases: [
      { title: "Progression", year: "2015", type: "EP" },
